  ...
  function Gitment() {
    ...
    if (query.code) {
      ...
      this.state.user.isLoggingIn = true;
        var logging = !proxy_gateway ? _utils.http.post('//github.com/login/oauth/access_token', { code: code, client_id: client_id, client_secret: client_secret }, '') : _utils.http.post('/login/oauth/access_token', 'code=' + code + '&client_id=' + client_id, proxy_gateway);
